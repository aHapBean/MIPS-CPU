...
HD_PWD='E:/Archlab/lab06/lab06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopBoard.tcl -notrace
